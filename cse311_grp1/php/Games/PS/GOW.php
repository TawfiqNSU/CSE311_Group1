...
<body>
	<div class="mainBody">	
		...
		<div class="login">
			...
			<br><br>
			<div class="section">
				<a href="../../../images/Games/god.png">
				<img src="../../../images/Games/god.png">
			</a>
			</div>
			<div class="section">
				<p>
		...
		<div class="description">
			...
			A NEW BEGINNING
			<br><br>
			From Santa Monica Studio and creative director Cory Barlog comes a new begining for one of gaming's most recognizable icons.<br><br>
			Living as a man outside the shadow of the gods, Kratos must adapt to unfamiliar lands, unexpected threats and a second chance at being a father.Together with his son Atreus, the pair will venture into the brutal norse wilds and fulfill a deeply personal quest.
			</div>
		</div>
