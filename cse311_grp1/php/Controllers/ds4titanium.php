...
<html>
<head>
	<title>DualShock 4 Titanium Blue</title>
...
<body>
	<div class="mainBody">	
		...
		<div class="login">
			...
			<br><br>
			<div class="section">
				<a href="../../images/Controllers/DS4TitanBlue.png">
				<img src="../../images/Controllers/DS4TitanBlue.png">
			</a>
			</div>
			<div class="section">
				<p>
			...
			<p>
				Product Name: DualShock 4 Titanium Blue
			</p>
			<p>
				Price: 5,000 Tk
			</p>
			...
			<button type="button" onclick="alert('It works')">Buy Now</button>
		</div>
		<br><br><br>
