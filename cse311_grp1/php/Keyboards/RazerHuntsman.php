...
<html>
<head>
	<title>Razer Huntsman Opto-Mechanical Switch Keyboard</title>
...
<body>
	<div class="mainBody">	
		...
		<div class="login">
			...
			<br><br>
			<div class="section">
				<a href="../../images/Keyboards/razerH.jpg">
				<img src="../../images/Keyboards/razerH.jpg">
			</a>
			</div>
			<div class="section">
				<p>
			...
			<p>
				Product Name: Razer Huntsman Opto-Mechanical Switch Keyboard
			<p>
				Price: 11,800 Tk
			</p>
			<p>
		...
		<table bgcolor="#393939">
			...
			<tr>
				<td>Type</td>
				<td>Razer™ Opto-Mechanical Switch with 45 G actuation force</td>
			</tr>
			<tr>
				<td>Anti-ghosting</td>
			...
			<tr>
				<td>Key</td>
				<td>Key stabilizer bar for precise, balanced actuation<br>
					100 million keystroke lifespan<br>
					Fully programmable keys with on-the-fly macro recording</td>
			</tr>
			<tr>
				<td>Razer Synapse</td>
				<td>Enabled</td>
