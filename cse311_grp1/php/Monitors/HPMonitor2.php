...
<html>
<head>
	<title>HP P244 23.8-inch Monitor</title>
...
<body>
	<div class="mainBody">	
		...
		<div class="login">
			...
			<br><br>
			<div class="section">
				<a href="../../images/Monitors/HP P244 23.8-inch Monitor 12600.jpg">
				<img src="../../images/Monitors/HP P244 23.8-inch Monitor 12600.jpg">
			</a>
			</div>
			<div class="section">
				<p>
			...
			<p>
				Product Name:HP P244 23.8-inch Monitor 
			<p>
				Price: 12,500Tk
			</p>
			<p>
		...
		<table bgcolor="#393939">
			...
			<tr>
				...
				<td>IPS w/LED backlight<br>
					Panel active area (W x H): 52.7 x 29.64 cm</td>
			</tr>
			<tr>
				<td>Screen Size	</td>
				<td>23.8-inch Full HD (1920 x 1080 @ 60 Hz)</td>
			</tr>
			<tr>
				<td>Resolution</td>
				<td>1920 x 1080</td>
			...
			<tr>
				<td>Dimension</td>
				<td>Dimensions With Stand (W x D x H): 54.66 x 20.99 x 40.51 cm<br>
					Dimensions (W x D x H): 54.66 x 4.47 x 32.1 cm</td>
			</tr>
			<tr>
				<td>Weight	</td>
				<td>3.65 kg</td>
