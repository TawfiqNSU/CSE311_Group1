...
<html>
<head>
	<title>Dell monitor 23 inch</title>
...
<body>
	<div class="mainBody">	
		...
		<div class="login">
			...
			<br><br>
			<div class="section">
				<a href="../../images/Monitors/dell monitor 22 inch 17000.jpg">
				<img src="../../images/Monitors/dell monitor 22 inch 17000.jpg">
			</a>
			</div>
			<div class="section">
				<p>
			...
			<p>
				Product Name:Dell monitor 23 inch
			<p>
				Price: 17,000Tk
			</p>
			<p>
		...
		<table bgcolor="#393939">
			...
			<tr>
				<td>Brightness	</td>
				<td>250 cd/m² (typical)</td>
			</tr>
			<tr>
				<td>Viewing Angle	</td>
				<td>160° vertical / 170° horizontal</td>
			</tr>
			<tr>
			...
			<tr>
				<td>Dimension</td>
				<td>Height with stand (compressed /extended): 415.0 mm (16.34 inches)<br>
					Depth: 180.0 mm (7.09 inches)<br>
					Width: 544.8 mm (21.45 inches)</td>
			</tr>
			<tr>
				<td>Weight	</td>
				<td>Weight (panel only - for VESA mount) 2.98 kg (6.57 lb)<br>
					Weight (with packaging) 5.09 kg (11.22 lb)</td>
			</tr>
			<tr>
				<td>Warranty</td>
