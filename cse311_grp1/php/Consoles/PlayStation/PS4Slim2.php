...
<html>
<head>
	<title>PlayStation 4 Slim 1TB</title>
...
<body>
	<div class="header">
		...
		<div class="login">
			...
			<p>
				Product Name: Play Station 4 Slim 8Gb RAM / 1TB HDD
			</p>
			<p>
				Price: 27,000 Tk
			</p>
